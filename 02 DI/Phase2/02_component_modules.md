...
# Phase 2: Dagger 2 – Topic 2: Implementing @Component and @Inject
...
Annotating classes isn't enough. We need an entry point—a way to reach into the graph and pull objects out. This is the role of the **Component**.
...
## 🛑 Interview Summary: @Component & @Inject
